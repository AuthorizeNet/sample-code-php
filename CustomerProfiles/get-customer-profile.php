<?php
  ...
  function getCustomerMerchantAuthentication()
  {
  ...
  function getCustomerProfileWithId($profileIdRequested)
  {
	  $request = new AnetAPI\GetCustomerProfileRequest();
	  $request->setMerchantAuthentication(getCustomerMerchantAuthentication());
  ...
  function getCustomerProfile($customerProfileId){
	  //merchant authentication is done in separate function
	  $refId = 'ref' . time();
	 ...
	 //  4. Validate Profiiel ID returned
	  ...
	  return getCustomerProfileWithId($profileIdRequested);
  }
